            ...
            <div className='flex flex-col gap-2'>
              ...
              >
                ...
                <div>
                  ...
                  <p className='text-description'>
                    When a loan is payed off, redirect its freed minimum payment as extra payment towards the next loan
                    in your strategy order
                  </p>
                </div>
              </div>
            ...
            <div className='flex flex-col gap-4'>
              ...
              <div className='card flex-col gap-3 items-start p-6'>
                ...
                <div className='flex justify-between items-center w-full'>
                  ...
                  <p className='text-sm'>
                    {formatCurrency(currentSimulationComparison.simulation.total_interest_paid)}
                  </p>
                </div>
                <div className='flex justify-between items-center w-full'>
